  ...
  return (
    <View style={styles.bigTabs}>
      <Pressable
        ...
        style={[styles.bigTab, active === "primary" && styles.bigTabOn]}
      >
        {/* <Icon name="list.bullet" size={18} color={active === 'primary' ? Colors.text : Colors.text50} /> */}
        <Txt
          variant="metaMedium"
          color={active === "primary" ? Colors.text : Colors.text50}
        >
          Primary
        </Txt>
        <CountBadge value={2} />
      ...
      <Pressable
        ...
        style={[styles.bigTab, active === "requests" && styles.bigTabOn]}
      >
        <Txt
          variant="metaMedium"
          color={active === "requests" ? Colors.text : Colors.text50}
        >
          Requests
        </Txt>
        {/* <CountBadge value={2} /> */}
...
function FilterTabs() {
  ...
  const items: {
    ...
    { label: "All", lime: true },
    { label: "Direct", icon: "paperplane.fill", lime: true },
        ...
        {items.map((it) => {
          ...
          return (
            <Pressable
              ...
              style={[styles.smallTab, on && styles.smallTabOn]}
            >
              {it.icon && (
                <Icon
                  name={it.icon}
                  size={14}
                  color={on ? Colors.text : Colors.text50}
                />
              )}
              ...
              {it.icon !== "sparkles" && (
                <CountBadge value={2} lime={it.lime} />
              )}
            </Pressable>
          );
        })}
