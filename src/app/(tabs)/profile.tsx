    ...
    <View style={styles.statCard}>
      ...
      <View style={{ gap: 0 }}>
        ...
        <View style={styles.deltaRow}>
          ...
          {delta && (
            <>
              <Icon name="arrow.up.right" size={12} color={Colors.lime} />
  ...
  return (
    <View style={styles.card}>
      ...
      <ScrollView
        ...
        contentContainerStyle={styles.insights}
      >
        {profileStats.map((s) => (
...
const styles = StyleSheet.create({
  ...
  qDot: {
    ...
    borderRadius: 3,
    backgroundColor: Colors.lime,
    boxShadow: "0px 0px 6px rgba(225,255,79,0.8)",
  },
});
